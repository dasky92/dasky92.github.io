...
Welcome to Verde Player (the "App"). By downloading, installing, or using the App, you agree to these Terms of Use (the "Terms"). If you do not agree, please do not use the App.

## Offline-First Music Player

The App is designed as an offline-first music player. Core features — including playback, library management, liked songs, playback history, and search — operate entirely on your device without requiring an internet connection.
...
All audio files and metadata you add to the App remain your exclusive property. We do not claim ownership over your content. You are responsible for ensuring that you have the legal right to store and play those files using the App.
